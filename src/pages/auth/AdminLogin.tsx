  ...
  return (
    <div className="relative w-full h-screen overflow-hidden">
      ...
      <div className="relative z-10 flex items-center justify-center md:justify-end h-full px-4 md:px-8 lg:pr-24">
        ...
        >
          <h2 className="text-2xl md:text-4xl font-bold mb-3">Admin Login</h2>
          <p className="text-lg md:text-xl text-gray-200 mb-6 md:mb-8">Sign in to access admin dashboard</p>
          ...
          <form onSubmit={handleSubmit} className={`space-y-4 md:space-y-6 transition-all ${error ? "animate-shake" : ""}`}>
            ...
            <motion.button
              ...
              type="submit"
              disabled={isLoading}
              className="w-full py-3 md:py-4 bg-blue-600 text-white font-semibold rounded-md transition mb-4 text-lg md:text-xl disabled:opacity-50"
            >
            ...
            <div className="mt-6 md:mt-8 text-center">
              <button
                ...
                className="text-blue-400 hover:underline text-base md:text-lg"
              >
